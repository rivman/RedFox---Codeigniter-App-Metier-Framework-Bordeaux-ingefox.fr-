...
/**
 * Display an "Feature is currently in development" alert message
 */
function unavailableFeature(){
    openModalText('En cours de développement','<div class="alert alert-info"><p>Cette fonctionnalité est en cours de développement et sera disponible prochainement.</p></div>');
}
